...
\begin{enumerate}[label=2.\arabic*, itemsep=8pt]
	...
	\begin{enumerate}[itemsep=8pt]
		...
		\begin{itemize}
			\item $x_1 = 0$; $x_2 = 0$ geeft $0 \times 0.5 + 0 \times 0.5 = 0.0 < t = 1.0$ dus $g = 0$
			\item $x_1 = 0$; $x_2 = 1$ geeft $0 \times 0.5 + 1 \times 0.5 = 0.5 < t = 1.0$ dus $g = 0$
			\item $x_1 = 1$; $x_2 = 0$ geeft $1 \times 0.5 + 0 \times 0.5 = 0.5 < t = 1.0$ dus $g = 0$
			\item $x_1 = 1$; $x_2 = 1$ geeft $1 \times 0.5 + 1 \times 0.5 = 1.0 = t = 1.0$ dus $g = 1$
		\end{itemize}

		\item De inputs/output geven de waarheidstabel van een OR-poort:
		\begin{itemize}
			\item $x_1 = 0$; $x_2 = 0$ geeft $0 \times 0.5 + 0 \times 0.5 = 0.0 < t = 0.5$ dus $g = 0$
			\item $x_1 = 0$; $x_2 = 1$ geeft $0 \times 0.5 + 1 \times 0.5 = 0.5 = t = 0.5$ dus $g = 1$
			\item $x_1 = 1$; $x_2 = 0$ geeft $1 \times 0.5 + 0 \times 0.5 = 0.5 = t = 0.5$ dus $g = 1$
			\item $x_1 = 1$; $x_2 = 1$ geeft $1 \times 0.5 + 1 \times 0.5 = 1.0 > t = 0.5$ dus $g = 1$
		\end{itemize}

		\item De input/output geeft de waarheidstabel van een INVERT-poort (met andere woorden, de logische NOT):
		\begin{itemize}
			\item $x_1 = 0$ geeft $0 \times -1 = 0.0 > t = -0.5$ dus $g = 1$
			\item $x_1 = 1$ geeft $1 \times -1 = -1.0 < t = -0.5$ dus $g = 0$
		\end{itemize}	\end{enumerate}


	\item PARTY-poort
	\begin{enumerate}[itemsep=8pt]
		\item Bijvoorbeeld: $x_1 = x_2 = x_3 = 1$ geeft \\ $1 \times 0.6 + 1 \times 0.3 + 1 \times 0.2 = 1.1 > t = 0.4$ dus $g = 1$
	    ...
	    \end{tabular}
	    	...
	    	\item Bijvoorbeeld: $x_1 = x_2 = x_3 = 1$ geeft \\ $1 \times 0.1 + 1 \times 0.3 + 1 \times 0.2 = 0.6 < t = 0.9$ dus $g = 0$
	...
	\item NOR-poort: zie figuur \ref{fig:nor_gate}.
		...
		\begin{tikzpicture}[scale=1, transform shape]
			\node (a)[circle, draw] at (4, 0) {$t = 0.0$};
			\node (x1)[] at (0, 2) {$x_1$};
			\node (x2)[] at (0, 0) {$x_2$};
			\node (x3)[] at (0, -2) {$x_3$};
	...
	\item XOR-poort: zie figuur \ref{fig:xor_gate}.
		...
		\begin{tikzpicture}[scale=1, transform shape]
			...
			\node (a)[circle, draw, minimum width=40pt] at (4, 2) {$t = 1$};
			\node (b)[circle, draw, minimum width=40pt] at (4, -2) {$t = -1$};
			\node (HL)[circle] at (4, -3) {Hidden layer};

			\node (c)[circle, draw, minimum width=40pt] at (8, 0) {$t=2$};
	...
	\item Half adder: zie figuur \ref{fig:adder}.
		...
		\begin{tikzpicture}[scale=1, transform shape]
			...
			\node (f)[circle, draw, minimum width=40pt] at (5, 4) {$t = 2$};
			\node (g)[circle, draw, minimum width=40pt] at (5, 0) {$t = 1$};
			\node (h)[circle, draw, minimum width=40pt] at (5, -4) {$t = -1$};
			\node (HL)[circle] at (5, -5) {Hidden layer};

			\node (c)[circle, draw, minimum width=40pt] at (10, 2) {$t=1$};
			\node (CL)[circle] at (11.5, 2) {Carry};
			\node (s)[circle, draw, minimum width=40pt] at (10, -2) {$t=2$};
	...
	\item Bitwise representation: zie figuur \ref{fig:bitwise}.
		...
		\end{tikzpicture}
		\caption{Oplossing binary representation. Treshold $t = 1$ voor elke $b_i$. De getekende verbindingen hebben allen $w=1$, de ontbrekende verbindingen hebben allen $w=0$.}
		\label{fig:bitwise}
		\end{figure}
